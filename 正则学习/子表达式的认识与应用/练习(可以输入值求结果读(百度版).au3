...
Local $str, $n
$path =@ScriptDir & "\百度源码.txt"

$Ra1_1 = 'color="#008000">(.{8,70})\d{4}-\d{1,2}-\d{1,2}'
$Ra1_2 = 'color="#008000">.{8,70}(\d{4}-\d{1,2}-\d{1,2})'
...
$Radio1 = GUICtrlCreateRadio("读取链接", 48, 232, 73, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
$Radio2 = GUICtrlCreateRadio("读取日期", 136, 232, 73, 17)
$Radio3 = GUICtrlCreateRadio("链接和日期", 224, 232, 73, 17);在文档里面要按tab键才可以看结果
$Radio4 = GUICtrlCreateRadio("整个框起", 312, 232, 73, 17)
;~ $Radio5 = GUICtrlCreateRadio("|使用", 392, 232, 73, 17);
;~ $Radio6 = GUICtrlCreateRadio("?使用", 472, 232, 73, 17);代表前面的元素字符出现0次或者任意次数
