...
Local $str, $n
$path ='<a href="space-uid-7620.html">冰点</a>'
$Ra1_1 = "[\x20-\x7f]"
$Ra1_2 = "[^a-z]"
$Ra1_3 = "[^0-9]"
$Ra1_4 = "[0-9a-z]"
$Ra1_5 = "[^\x20-\x7f]"
$Form1 = GUICreate("正则", 616, 458, 192, 124)
...
;GUICtrlSetData(-1, "")
$Radio1 = GUICtrlCreateRadio("去除中文", 32, 384, 73, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
$Radio2 = GUICtrlCreateRadio("去除字母", 120, 384, 73, 17)
$Radio3 = GUICtrlCreateRadio("去除数字", 208, 384, 73, 17)
$Radio4 = GUICtrlCreateRadio("提取数字和字符",  296, 384, 105, 17)
$Radio5 = GUICtrlCreateRadio("提取中文", 416, 384, 73, 17)
$Button1 = GUICtrlCreateButton("正则", 160, 416, 273, 33)
GUISetState(@SW_SHOW)
