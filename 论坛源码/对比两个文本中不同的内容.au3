...
$w=_FileListCompare('2.txt','1.txt','1.txt');2是最新的文件，1是旧文件
;$w=_FileListCompare('J:\ADMuncher最终汉化版\2.txt','C:\Users\chtyfox\Desktop\1.txt','C:\Users\chtyfox\Desktop\1.txt')
_ArrayDisplay($w)
...
Func _FileListCompare($hSouce,$hTarget,$hOutPut)
        ...
        For $hSi = 1 To $hLine_S
                ...
                If Not StringInStr($hCon_T,$hS_String) Then
                        FileWriteLine(@CRLF & $hOutPut,$hS_String)
                EndIf
        Next
EndFunc
