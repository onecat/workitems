...
$QQPath = IniRead(@ScriptDir & "\QQPath.ini", "QQ路径", "QQPath","")
;~ [QQ路径]
;~ QQPath=G:\toors\QQ\Bin\
ShellExecute("QQ.exe","",$QQPath)
			...
			If WinExists($title, $text) Then ;判断
				...
				For $i = 0 To UBound($array) - 1
					...
					ControlSetText($title, $text, "[CLASS:" & $array[$i] & "; INSTANCE:1]", "帐号", 1);账号 QQ1648872206
				Next
