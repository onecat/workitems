        ...
        Switch GUIGetMsg()
                Case $GUI_EVENT_CLOSE
				 ...
				 Case $Button1 
					...
					_IENavigate($oIE, "http://www.chrome-extension-downloader.com/landing.php?source=chrome-extension&extension=" & GUICtrlRead($Input1))
					$URLClick = 0
					$sHTML = _IEBodyReadHTML ($oIE)
					$XZ = StringRegExp($sHTML, '<A class=download href=\"(.+?)\" rel=', 3)
					$DZ = $XZ[0]
					_IENavigate($oIE,$DZ)
					$URLClick = 0
