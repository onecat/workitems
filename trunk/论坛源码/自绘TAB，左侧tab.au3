...
GUICtrlCreateEdit("测试数据第一页里放EDIT控件", 130, 60, 300, 220, 0x00C0)
GUICtrlCreateButton("确定", 450, 150, 60, 40)
 
GUICtrlCreateTabItem("插入")
GUICtrlCreateLabel("第二页文字，看看效果", 130, 80)
GUICtrlCreateCombo("", 130, 150, 60, 120)
GUICtrlSetData(-1, "Trids|CyberSlug|Larry|Jon|Tylo", "Jon")
GUICtrlCreateButton("改变", 280, 150, 50, 20)
 
GUICtrlCreateTabItem("页面布局")
GUICtrlCreateLabel("第三页在这里", 130, 80)
 
GUICtrlCreateTabItem("引用")
GUICtrlCreateButton("第4页了", 130, 80)
GUICtrlCreateTabItem("审阅")
GUICtrlCreateButton("这是第5页哦", 130, 80)
...
Func DrawTAB($hDC, $nTabID, $TabState, $nLeft, $nTop, $nRight, $nBottom)
        ...
        If $nTabID = $TABActiveID Then;相等就是当前选项卡
                _JiuGongDraw($hDC, $nLeft, $nTop, $nRight, $nBottom, $hBmpDC, 0, 13 - $TabState * 13, 27, 13, 5, 6, 2, 6);$TabState是Hover标志
        Else
                If $TabState = 0 Then
