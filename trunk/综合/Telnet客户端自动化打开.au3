...
If $msg = 6 Then 
	...
	;$h = ControlTreeView ( "Windows 功能", "", "SysTreeView321", "Exists" , "Telnet 客户端" )
;If $h = 1 Then
	WinActivate("Windows 功能")
;EndIf

;MsgBox(1,"22",$h)
$r = ControlTreeView ( "Windows 功能", "", "SysTreeView321", "IsChecked" , "Telnet 客户端" )

If $r = 0 Then
     ControlTreeView ( "Windows 功能", "", "SysTreeView321", "Check" , "Telnet 客户端" )
EndIf
ControlClick("Windows 功能","确定","Button1")
