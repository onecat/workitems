...
#PRE_icon=N:\测试脚本\查询SN ID资料(安联和Urmet和GTC).exe|-1
#PRE_Outfile=查询SN ID资料(安联和Urmet和GTC).exe
#PRE_UseUpx=n
#PRE_Res_Comment=小站
...
Func WZ()
If GUICtrlRead($Radio1) = $GUI_CHECKED Then $sUrl = "http://anlian.co/queryinfo.php?DevID=" & GUICtrlRead($Input1)
If GUICtrlRead($Radio2) = $GUI_CHECKED Then $sUrl = "http://www.urmetddns.com/queryinfo.php?DevID=" & GUICtrlRead($Input1) 	
If GUICtrlRead($Radio3) = $GUI_CHECKED Then $sUrl = "http://www.eye-gtc.co/queryinfo.php?DevID=" & GUICtrlRead($Input1)
