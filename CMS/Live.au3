...
;$1 = WinGetTitle("#32770", "Check All");获取窗口标题
;MsgBox(1,"@2",$1 )
...
Func save()
	...
	sl()
	$var = ControlGetText("Remote Setup(14)", "Save Live Succeed!", "Static1");获取指定控件上的文本.
	$I=StringCompare($var,"Save Live Succeed!");按选项比较两个字符串.
