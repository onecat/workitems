...
$NUM = 0
If FileExists(@ScriptDir & "\结果.au3") = 1 Then FileDelete(@ScriptDir & "\结果.au3")
$FILE1 = FileSelectFolder("选择待装入目录", "", 2)
If @error = 1 Then Exit
$FILE2 = StringRight($FILE1, StringLen($FILE1) - StringInStr($FILE1, "\", 1, -1))
_FILELIST($FILE1)
$TEMP = ""
$FORM1 = GUICreate("释放路径设定", 343, 249, -1, -1, BitOR($WS_MINIMIZEBOX, $WS_CAPTION, $WS_POPUP))
...
$LABEL2 = GUICtrlCreateLabel("常用目录宏", 16, 96, 72, 17)
$LIST1 = GUICtrlCreateList("", 16, 120, 180, 97, BitOR($WS_HSCROLL, $WS_VSCROLL, $WS_BORDER))
$LABEL3 = GUICtrlCreateLabel("BY： 风雪夜归人", 224, 128, 108, 17)
$LABEL4 = GUICtrlCreateLabel("QQ群：12467473", 224, 160, 108, 17)
$RADIO1 = GUICtrlCreateRadio("覆盖", 144, 80, 57, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
$RADIO2 = GUICtrlCreateRadio("不覆盖", 208, 80, 65, 17)
$BUTTON3 = GUICtrlCreateButton("帮助", 88, 90, 43, 25)
...
$LABEL5 = GUICtrlCreateLabel("生成进度提示", 20, 228, 140, 20)
